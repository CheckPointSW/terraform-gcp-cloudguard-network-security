...
variable "image_name" {
  type = string
  description = "The autoscaling (MIG) image name."
}
...
variable "external_network_project" {
  type = string
  description = "The project in which the external network and subnetwork belongs. If empty, the provider project is used."
  default = ""
}
...
variable "internal_network_project" {
  type = string
  description = "The project in which the internal network and subnetwork belongs. If empty, the provider project is used."
  default = ""
}
