...
output "external_ipv6" {
  value = length(google_compute_instance.gateway.network_interface[0].ipv6_access_config) > 0 ? google_compute_instance.gateway.network_interface[0].ipv6_access_config[0].external_ipv6 : null
}
